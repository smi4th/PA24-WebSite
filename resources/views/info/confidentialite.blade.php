...
<body>
    ...
    <div class="container mt-5">
        ...
        <div><br></div>
        <div>Code postal :&nbsp; 15 Rue des Lilas</div>
        <div>Courriel :&nbsp; contact@pariscaretaker.com</div>
        <div>Téléphone :&nbsp; 01 23 45 67 89</div>
        <div></div>
        <div><br></div>
        <h2>Droit d’accès</h2>
        ...
        <div><br></div>
        <div>Code postal :&nbsp; 15 Rue des Lilas, 75014, Paris</div>
        <div>Courriel :&nbsp; contact@pariscaretaker.com</div>
        <div>Téléphone :&nbsp; 01 23 45 67 89</div>
        <div></div>
        <div><br></div>
